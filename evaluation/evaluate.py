...
from evaluation.evaluate_total_mean import calculate_mean
...
def calculate_metric(metrics_calculator,metric, src_image, tgt_image, src_mask, tgt_mask,src_prompt,tgt_prompt):
    ...
    if metric=="clip_similarity_source_image":
        ...
        return metrics_calculator.calculate_clip_similarity(tgt_image, src_prompt,None) # reconstruction: tgt = src
...
all_tgt_image_folders={
    ...
    # ---
    "1_ddim+masactrl+nonrigid":"output/202504_nonrigid/ddim+masactrl/annotation_images",
    "1_directinversion+masactrl+nonrigid":"output/202504_nonrigid/directinversion+masactrl/annotation_images",
    # ---
    ...
    # ---
    "1_ddim+pnp+nonrigid":"output/202504_nonrigid/ddim+pnp/annotation_images",
    "1_directinversion+pnp+nonrigid":"output/202504_nonrigid/directinversion+pnp/annotation_images",
    # ---
    "1_directinversion+FlexiEdit":"/memory/yangkaixiang/SurgicalVideoEdit/FlexiEdit/outputs/result_flexiedit_PIE_Bench/annotation_images",
    # ---
...
if __name__=="__main__":
    ...
    parser.add_argument('--infer_dir', default='') # rerun existing images
    ...
    if evaluate_whole_table:
        ...
        try:
            ...
            tgt_image_folders[tgt_methods[0]]=infer_dir
    ...
    for key, item in annotation_file.items():
        ...
        for tgt_image_folder_key,tgt_image_folder in tgt_image_folders.items():
            ...
            if tgt_image.size[0] != 512:
                tgt_image = tgt_image.resize((512, 512), Image.LANCZOS)
    ...
    calculate_mean(result_path, result_path[:-4]+'_mean.csv')