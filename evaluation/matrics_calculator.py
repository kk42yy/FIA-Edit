...
class VitExtractor:
    ...
    def __init__(self, model_name, device):
        ...
        # self.model = torch.hub.load('/home/yangkaixiang/.cache/torch/hub/facebookresearch_dino_main', model_name, source='local').to(device)
        self.model.eval()
...
class MetricsCalculator:
    def __init__(self, device) -> None:
        ...
        # self.clip_metric_calculator = CLIPScore(model_name_or_path="/home/yangkaixiang/.cache/huggingface/hub/models--openai--clip-vit-large-patch14/snapshots/32bd64288804d66eefd0ccbe215aa642df71cc41").to(device)
    ...
    def calculate_structure_distance(self, img_pred, img_gt, mask_pred=None, mask_gt=None, use_gpu = True):
        ...
        assert img_pred.shape == img_gt.shape, f"Image shapes should be the same. {img_pred.shape, img_gt.shape}"
